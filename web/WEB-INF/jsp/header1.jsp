<%-- 
    Document   : header1
    Created on : Nov 21, 2017, 8:11:09 PM
    Author     : Hoarom
--%>
...
<body> 
    <div id="fb-root" class=" fb_reset">
        <div style="position: absolute; top: -10000px; height: 0px; width: 0px;">
            <div>
                <iframe name="fb_xdm_frame_https" frameborder="0" allowtransparency="true" allowfullscreen="true" scrolling="no" id="fb_xdm_frame_https" aria-hidden="true" title="Facebook Cross Domain Communication Frame" tabindex="-1" src="https://staticxx.facebook.com/connect/xd_arbiter/r/lY4eZXm_YWu.js?version=42#channel=f22f2afef0d1fd4&amp;origin=https%3A%2F%2Fwww.memrise.com" style="border: none;">
        ...
        <div class="header-row row">
            ...
            <ul class="header-nav ">
                ...
                <li class="header-nav-item plain ">
                    <a href="/Elearning/course" class="nav-item-btn">
                ...
                <li class="header-nav-item plain create ">
                    <a href="#" class="nav-item-btn">
                        <span class="nav-item-btn-text">Groups</span>
                    </a>
                </li>
                ...
                <li class="header-nav-item colored premium">
                    <a href="#" class="nav-item-btn">
                        <span class="ico"></span>
                        <span class="nav-item-btn-text">Go Pro</span>
                    </a>
                </li>


                <li class="header-profile-wrapper">
                    <span class="header-info-card js-info-toggle sel-info-toggle">
                        <span class="info-card-inner" accesskey="h">
                            <span class="info-card-picture">
                                <img class="profile-avatar" src="https://d2rhekw5qr4gcj.cloudfront.net/img/100sqf/from/uploads/profiles/Hoa_Dinhh_171014_0919_51.jpg" alt=""/>
                            </span>
                        </span>
                    </span>
                    ...
                    <div class="header-profile-inner">
                        <div class="profile-row profile-details">
                            <div class="loading-spinner"></div>
                        </div>

                        <div class="profile-row profile-links">
                            <a href="/user/Hoa_Dinhh/" class="profile-link">
                            ...
                            <a href="/settings/" class="profile-link">
                                ...
                                <span class="profile-link-text">Settings</span>
                            </a>
                            <a href="/logout/" class="profile-link js-logout sel-logout">
                                <i class="profile-link-icon link-icon-3"></i>
                                <span class="profile-link-text">Log out</span>
                            </a>
                        </div>
                    </div>
    ...
    <div id="page-head" class="">
        <div class="inner">
            ...
            <span class="sel-home-head"></span>




            <div id="listening-upsell-modal" class="modal fade upsell-modal" role="dialog" data-tracking-name="">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-body">
                            <h2 class="modal-title">Hear ye, hear ye!</h2>
                            <p class="modal-description">
                                Fine tune your listening skills with a mode made for your ears, with the sweet sounds of native speakers. Exclusive to Pro members.
                            </p>
                            <div class="upsell-modal-image"></div>
                        </div>


                        <div class="modal-footer">
                            <a href="/premium/pay/annual/?offer=OLIVER&amp;source=dashboard&amp;upsell_name=Nov_50source=mode_selector&learning_session_type=audio" class="button green huge btn-promo">
                                <span>Go Pro</span>
                            </a>
                            <div class="full-pricing">
                                <a class="see-all-plans" href="/premium/">SEE FULL PRICING</a>
                            </div>
                        </div>
                    </div>
                    <button type="button" class="close" data-dismiss="modal">
                        <svg width="24" height="24" viewBox="0 0 24 24"><path fill-rule="evenodd" clip-rule="evenodd" d="M18.717 6.697l-1.414-1.414L12 10.586 6.697 5.283 5.283 6.697 10.586 12l-5.303 5.303 1.414 1.414L12 13.414l5.303 5.303 1.414-1.414L13.414 12z" opacity=".75"/></svg>
                    </button>
                </div>
            </div>


            <div id="difficult-words-upsell-modal" class="modal fade upsell-modal" role="dialog" data-tracking-name="">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-body">
                            <h2 class="modal-title">Master difficult words, fast!</h2>
                            <p class="modal-description">
                                Master troublesome words and boost your learning speed with this personalised game mode. Exclusive to Pro members.
                            </p>
                            <div class="upsell-modal-image"></div>
                        </div>
                        ...
                        <div class="modal-footer">
                            <a href="/premium/pay/annual/?offer=OLIVER&amp;source=dashboard&amp;upsell_name=Nov_50source=mode_selector&learning_session_type=difficult_words" class="button green huge btn-promo">
                                <span>Go Pro</span>
                            </a>
                            <div class="full-pricing">
                                <a class="see-all-plans" href="/premium/">SEE FULL PRICING</a>
            ...
            <div id="grammarbot-upsell-modal" class="modal fade upsell-modal" role="dialog" data-tracking-name="">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-body">
                            <h2 class="modal-title">Become a Grammar Pro!</h2>
                            <p class="modal-description">
                                Learn the tricks of the grammar trade with a little help from our new Grammarbot. Exclusive to Pro members.
                            </p>
                            <div class="upsell-modal-image"></div>
                        </div>
                        ...
                        <div class="modal-footer">
                            <a href="/premium/pay/annual/?offer=OLIVER&amp;source=dashboard&amp;upsell_name=Nov_50source=mode_selector&learning_session_type=grammar" class="button green huge btn-promo">
                                <span>Go Pro</span>
                            </a>
                            <div class="full-pricing">
                                <a class="see-all-plans" href="/premium/">SEE FULL PRICING</a>
            ...
            <div id="chat-upsell-modal" class="modal fade upsell-modal" role="dialog" data-tracking-name="">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-body">
                            <h2 class="modal-title">Have a chat!</h2>
                            <p class="modal-description">
                                Build your conversation skills with a little help from our international chatbots. Exclusive to Pro members.
                            </p>
                            <div class="upsell-modal-image"></div>
                        </div>
                        ...
                        <div class="modal-footer">
                            <a href="/premium/pay/annual/?offer=OLIVER&amp;source=dashboard&amp;upsell_name=Nov_50source=mode_selector&learning_session_type=pro_chat" class="button green huge btn-promo">
                                <span>Go Pro</span>
                            </a>
                            <div class="full-pricing">
                                <a class="see-all-plans" href="/premium/">SEE FULL PRICING</a>
            ...
            <div id="mtn-upsell-modal" class="modal fade upsell-modal" role="dialog" data-tracking-name="">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-body">
                            <video id="mtn-video" class="modal-video" src="https://d2rhekw5qr4gcj.cloudfront.net/video/mtn-1.mp4" type="video/mp4" playsinline></video>
                            <div class="modal-text-wrapper">
                                <h2 class="modal-title">Learn with locals!</h2>
                                <p class="modal-description">
                                    Learn with videos of locals, exclusive to Pro members
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="modal-footer">
                            <a href="/premium/pay/annual/?offer=OLIVER&amp;source=dashboard&amp;upsell_name=Nov_50source=mode_selector&learning_session_type=meet-the-natives" class="button green huge btn-promo">
                                <span>Go Pro</span>
                            </a>
                            <div class="full-pricing">
                                <a class="see-all-plans" href="/premium/">SEE FULL PRICING</a>
            ...
            <div id="stats-upsell-modal" class="modal fade upsell-modal" role="dialog" data-tracking-name="">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-body">
                            <h2 class="modal-title">We predict a 99% chance of you loving this!</h2>
                            <p class="modal-description">
                                Get your learning stats, including how much you've learnt, how accurate you are and when you learn best. Exclusive to Pro members
                            </p>
                            <div class="upsell-modal-image"></div>
                        </div>
                        ...
                        <div class="modal-footer">
                            <a href="/premium/pay/annual/?offer=OLIVER&amp;source=dashboard&amp;upsell_name=Nov_50source=mode_selector&learning_session_type=stats" class="button green huge btn-promo">
                                <span>Go Pro</span>
                            </a>
                            <div class="full-pricing">
                                <a class="see-all-plans" href="/premium/">SEE FULL PRICING</a>
